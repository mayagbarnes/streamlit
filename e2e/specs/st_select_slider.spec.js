...
describe("st.select_slider", () => {
  ...
  it("shows labels", () => {
    ...
    cyGetIndexed(".stSlider label", 5).should("have.text", "Label 6");
  });
  ...
  it("has correct values", () => {
    ...
    cyGetIndexed(".stMarkdown", 4).should(
      "have.text",
      "Value 5: ('orange', 'blue')"
    );

    cyGetIndexed(".stMarkdown", 5).should("have.text", "Value 6: 1");

    cyGetIndexed(".stMarkdown", 6).should(
      "have.text",
  ...
  it("calls callback if one is registered", () => {
    ...
    cyGetIndexed('.stSlider [role="slider"]', 8)
      .click()
      .type("{rightarrow}", { force: true });
